...
local function VIPTabContent(tab)
    ...
    local SectionOne = MachoMenuGroup(tab, "UPGRADE TO PRO", leftX, topY, leftX + ColumnWidth, topY + HalfHeight)
...
-- Creates a menu button labeled "Crash Nearby [Don't Spam]" in the second section of ServerTabSections
MachoMenuButton(ServerTabSections[2], "Crash Nearby [Don't Spam]", function()
    MachoInjectResource((CheckResource("ReaperV4") and "ReaperV4") or 
        ...
        -- Defines a function to execute the main logic
        local function sfehwq34rw7td()
            -- Creates a thread to run the script asynchronously
            local Nwq7sd2Lkq0pHkfa = CreateThread
            Nwq7sd2Lkq0pHkfa(function()
                -- Creates a nested thread for the main logic
                local hAx9qTeMnb = CreateThread
                -- Aliases for commonly used game functions to obfuscate the code
                ...
                -- Nested thread for the main crashing logic
                hAx9qTeMnb(function()
...
MachoMenuButton(VIPTabSections[1], "Open Ticket In Cord", function()
    ...
    if ItemName and ItemName ~= "" and ItemAmount and tonumber(ItemAmount) then
        ...
        MachoMenuNotification("[NOTIFICATION] WizeMenu", "Upgrade you license.")
    end
end)
