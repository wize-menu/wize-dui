...
local function getUserKey()
    -- Replace with your executor's input function (e.g., Synapse X's input prompt)
...
-- Loop to prompt for key until valid
local CurrentKey
while not CurrentKey or not isKeyValid(CurrentKey) do
    CurrentKey = getUserKey()
    if not CurrentKey then
        MachoMenuNotification("WizeMenu", "No key provided. Please enter a valid key.", 10)
    elseif not isKeyValid(CurrentKey) then
        MachoMenuNotification("WizeMenu", "Your key ain't valid lmfao: " .. CurrentKey, 10)
    end
end

-- Key is valid, proceed
MachoMenuNotification("WizeMenu", "Key validated successfully: " .. CurrentKey, 5)
